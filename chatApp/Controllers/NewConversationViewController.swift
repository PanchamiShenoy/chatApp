...
//        chat.title = results[indexPath.row].username
...
//               }
        ...
        chatVC.chat = ChatModel(users: users, lastMessage: nil, messagesArray: [], otherUserIndex: 1)
             // chat.chat = ChatModel(users: users, lastMessage: nil, messages: [], otherUser: 1)
